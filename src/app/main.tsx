...
const itemList1 = [
  {
    ...
    description: (
      <>
        Выбирайте товар, который подходит по цене и характеристикам. Если товара
        нет в наличии — мы сообщим вам о его поступлении.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Вы можете оплатить покупку наличными, картой, онлайн на сайте, через
        интернет-банкинг или в кредит от «Сбербанка».
      </>
    ),
  },
  {
    ...
    description: (
      <>
        При покупке вам выдается кассовый чек, товарный чек и гарантийный талон
        – эти документы дают право на гарантийное обслуживание.
      </>
    ),
  },
  {
...
const itemList2 = [
  {
    ...
    description: (
      <>
        Устраним любую неисправность. Обычно делаем это за 1-3 дня, если ремонт
        сложный — предупредим заранее.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Покроем электросамокат изнутри специальным веществом, которое
        предотвратит попадание влаги и позволит кататься в любое время года.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Не навязываем услуги, диагностируем и заранее обговариваем стоимость
        ремонта.
      </>
    ),
  },
  {
    ...
    title: (
      <>
        Даем гарантию <b>14</b> дней на ремонт
      </>
    ),
    description: "",
  },
  {
    ...
    description: (
      <>
        Благодаря прямой связи с производителем имеем в наличии все необходимые
        новые комплектующие для ремонта.
      </>
    ),
  },
  {
    ...
    <MainPageStyled>
      ...
      <Container>
        ...
        <H2 align="center" marginBottom={18}>
          Предлагаем самые выгодные цены <br /> на продукты Kugoo за счет прямых
          поставок
        </H2>
        <MainPageText>и заботимся об удобстве покупателей</MainPageText>
        <Tabs
          item1={<CardAdvantagesBox itemList={itemList1} />}
          item2={<CardAdvantagesBox itemList={itemList2} />}
        />
        <H2 align="center" marginBottom={34}>
