...
const MenuCatalogBtn = styled(Link)`
  display: flex;
  align-items: center;
  height: ${rem(43)};
...
const MenuComparisonBtn = styled(Link)`
  display: flex;
  align-items: center;
  margin-right: ${rem(25)};
`;

const MenuFavoritesBtn = styled(Link)`
  display: flex;
  align-items: center;
  margin-right: ${rem(25)};
`;

const MenuBasketBtn = styled(Link)`
  display: flex;
  align-items: center;
  font-weight: 500;
  font-size: 14px;
